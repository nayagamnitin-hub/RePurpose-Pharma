...
_SYS = (
    ...
    "reports. For each drug provide: established (true only if it is an approved or standard treatment used "
    "specifically FOR this goal), relevant (false if it is off-goal, a trial co-intervention, or acts in the "
